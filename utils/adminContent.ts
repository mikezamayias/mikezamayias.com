    ...
    work: {
        ...
        fields: [
            ...
            },
            {
                ...
                label: "Stack",
                type: "csv",
                hint: "Comma-separated lowercase tags (flutter, openai). The public site shows their proper names.",
            },
            {
                path: "platform",
                label: "Platform",
                type: "text",
                emptyAsUndefined: true,
                hint: "Where it runs, as readers see it: iOS, macOS, Web, CLI.",
            },
            {
                path: "status",
                label: "Status",
                ...
                options: [
                    ...
                    { label: "Open for testing", value: "testing" },
